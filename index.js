...
const FH = (function () {
    ...
    function _showDialog(message, selector) {
        ...
        if(!dialogDiv){
            ...
            dialogDiv.setAttribute('role', 'tooltip');
    ...
    function _showFeatureHelp() {
        ...
        const step = _steps[_counter];

        // look for 10 seconds to wait for element to show in dom
            ...
            if (element) {
                ...
                const elementInViewPortTimer = setInterval(() => {
                    if (_isInViewport(element)) {
                        ...
                        // Handling click of close button of dialog
